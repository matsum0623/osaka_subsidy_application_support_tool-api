...
module.exports = {
  ...
  get_additional: async (after_school_id) => {
  ...
  put: async (after_school_id, instructor_id, instructor_name, qualification, additional, medical_care, seiki, koyou, hire_date, order, retirement_date=false) => {
